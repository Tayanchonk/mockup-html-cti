    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <header className="bg-dark-800 border-b border-dark-700 px-6 py-4">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">OCR Scanner Dashboard</h1>
          <button
      ...
      <main className="p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Manage your OCR scanning tasks and view processing results</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="card p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-white">Avg. Processing Time</h3>
                  <p className="text-2xl font-bold text-primary-500">2.3s</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card p-6">
              ...
              <p className="text-gray-400 mb-6">
                Upload images or PDFs to extract text using our advanced OCR technology
              </p>
              <button
                onClick={goToUpload}
            ...
            <div className="card p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2 border-b border-dark-600">
                  <span className="text-gray-300">invoice_2024.pdf</span>
                  <span className="text-primary-500 text-sm">Completed</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-dark-600">
                  <span className="text-gray-300">contract_scan.jpg</span>
                  <span className="text-primary-500 text-sm">Completed</span>
                </div>
                <div className="flex items-center justify-between py-2">
                  <span className="text-gray-300">receipt_001.png</span>
